<?php
session_start();
include_once $_SERVER['banksystem']. 'C:\wamp\www\PROJECT1\Bankpage\conn.php';
...
<div class="columns">
	<h1 class="title column is-offset-4-desktop pt-5 has-text-white">SDCKBANK USER DASHBOARD</h1>
</div>
	...
	<div class="card column is-6">
		...
		<div>
			...
			<form action="">
				...
				<button class="button is-success has-background-black is-size-6 ml-4" formaction="transfer.php">Make Transfer</button>
			</form>
